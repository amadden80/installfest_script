...
```
bash <(curl -sL https://raw.githubusercontent.com/amadden80/installfest_script/master/builds/mac)
```
...
```
bash <(wget -qO- https://raw.githubusercontent.com/amadden80/installfest_script/master/builds/ubuntu)
```
## Step 2
